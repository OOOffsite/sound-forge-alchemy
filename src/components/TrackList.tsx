...
export default function TrackList({
  ...
  return (
    <div className="space-y-4 relative" role="region" aria-label="Playlist Panel">
      {/* Sticky filter and action controls */}
      <div className="sticky top-0 z-20 bg-background border-b border-border pb-2">
      ...
      <div className="sticky bottom-0 bg-background pt-2 pb-2 z-10 flex items-center border-t border-border px-2">
