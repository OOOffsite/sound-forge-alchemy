            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 not-prose mt-6">
                <div className="border p-4 rounded-md flex">
                  <div className="mr-4">
                    <lucide_react_1.Download className="h-8 w-8 text-primary"/>
                  </div>
                  <div>
                ...
                <div className="border p-4 rounded-md flex">
                  <div className="mr-4">
                    <lucide_react_1.Music2 className="h-8 w-8 text-primary"/>
                  </div>
                  <div>
                ...
                <div className="border p-4 rounded-md flex">
                  <div className="mr-4">
                    <lucide_react_1.FileMusic className="h-8 w-8 text-primary"/>
                  </div>
                  <div>
                ...
                <div className="border p-4 rounded-md flex">
                  <div className="mr-4">
                    <lucide_react_1.Headphones className="h-8 w-8 text-primary"/>
                  </div>
                  <div>
